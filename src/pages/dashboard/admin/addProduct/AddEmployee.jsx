...
function AddEmployee() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("added Employee successfully:", response.data);
...
<div className="form-group">
        ...
        <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" name="tinnumber" value={formData.tinnumber} onChange={handleChange} id="TIN" className="w-full p-2 border border-gray-300 rounded-md" />
          </div>
          <div className="form-group">
